...
export const CheckIcon = props => {
  return (
    <IconShell {...props} name="check">
      <path d="M3.7071 11.2929c-.3905-.3905-1.0237-.3905-1.4142 0-.3905.3905-.3905 1.0237 0 1.4142L3.707 11.293zM9 18l-.7071.7071c.3905.3905 1.0237.3905 1.4142 0L9 18zM21.7071 6.7071c.3905-.3905.3905-1.0237 0-1.4142-.3905-.3905-1.0237-.3905-1.4142 0l1.4142 1.4142zm-19.4142 6l6 6 1.4142-1.4142-6-6L2.293 12.707zm7.4142 6l12-12-1.4142-1.4142-12 12 1.4142 1.4142z" />
    </IconShell>
  );
};
...
export const CloseIcon = props => {
  return (
    <IconShell {...props} name="close">
      <path d="M4.2929 18.2929c-.3905.3905-.3905 1.0237 0 1.4142.3905.3905 1.0237.3905 1.4142 0L4.293 18.2929zM19.707 5.7071c.3905-.3905.3905-1.0237 0-1.4142-.3905-.3905-1.0237-.3905-1.4142 0l1.4142 1.4142zm-1.4142 14c.3905.3905 1.0237.3905 1.4142 0 .3905-.3905.3905-1.0237 0-1.4142l-1.4142 1.4142zM5.7071 4.2929c-.3905-.3905-1.0237-.3905-1.4142 0-.3905.3905-.3905 1.0237 0 1.4142L5.707 4.293zm0 15.4142l7-7-1.4142-1.4142-7 7 1.4142 1.4142zm7-7l7-7-1.4142-1.4142-7 7 1.4142 1.4142zm-1.4142 0l7 7 1.4142-1.4142-7-7-1.4142 1.4142zm1.4142-1.4142l-7-7L4.293 5.707l7 7 1.4142-1.4142z" />
    </IconShell>
  );
};
